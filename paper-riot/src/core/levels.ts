...
export function buildLevels(): LevelDef[] {
  const desk: LevelDef[] = [
    ...
    L({
      ...
      moves: 26,
      goals: [collect("skull", 10), collect("star", 10)],
      shape: "rect",
      colors: 6,
    ...
    L({
      ...
      moves: 24,
      goals: [collect("star", 12), collect("skull", 12)],
      shape: "rect",
      colors: 6,
    ...
    L({
      ...
      zone: "desk",
      name: "Torn Corner",
      brief: "Black tape: 2 peels. Plane and rocket bounce off it.",
      moves: 24,
    ...
    L({
      ...
      zone: "desk",
      name: "Glue Stick",
      brief: "Glue pins stickers — they won't fall until peeled twice.",
      moves: 22,
      goals: [collect("flame", 10), collect("skull", 9)],
      shape: "narrow",
      colors: 6,
    ...
    L({
      ...
      zone: "desk",
      name: "Supply Closet",
      brief: "Boxes block swaps. Plane/rocket bounce — crack from the side.",
      moves: 22,
      goals: [collect("heart", 10), collect("gem", 10)],
      shape: "square",
      colors: 6,
    ...
    L({
      ...
      moves: 20,
      goals: [collect("gem", 14), collect("heart", 12)],
      shape: "bite",
      colors: 6,
      obstaclePlan: [
  ...
  const hall: LevelDef[] = [
    ...
    L({
      ...
      zone: "hall",
      name: "Padlock Row",
      brief: "Locks need a match of 4+ beside them — or a bomb.",
      moves: 22,
      goals: [collect("pizza", 10), collect("star", 12)],
      shape: "rect",
      colors: 6,
    ...
    L({
      ...
      moves: 22,
      goals: [collect("flame", 14), collect("spray", 11)],
      shape: "donut",
      colors: 6,
    ...
    L({
      ...
      zone: "hall",
      name: "Wet Floor",
      brief: "Wet smears slip after a swap — then peel beside them.",
      moves: 22,
      goals: [collect("skull", 12), collect("star", 12)],
      shape: "narrow",
      colors: 6,
    ...
    L({
      ...
      zone: "hall",
      name: "Tar Trap",
      brief: "Tar spreads if you leave it. Crack it fast.",
      moves: 20,
      goals: [collect("heart", 11), collect("flame", 12)],
      shape: "stairs",
      colors: 6,
    ...
    L({
      ...
      moves: 18,
      goals: [collect("gem", 16), collect("skull", 12)],
      shape: "lanes",
      colors: 6,
      obstaclePlan: [
  ...
  const yard: LevelDef[] = [
    ...
    L({
      ...
      moves: 20,
      goals: [collect("gem", 16), collect("pizza", 10)],
      shape: "diamond",
      colors: 6,
    ...
    L({
      ...
      zone: "yard",
      name: "Barbed Wire",
      brief: "Barbed ignores side matches — blast or staple the fence.",
      moves: 20,
      goals: [collect("spray", 11), collect("skull", 12)],
      shape: "rect",
      colors: 6,
    ...
    L({
      ...
      zone: "yard",
      name: "Glue Flood",
      brief: "Glue flood — pinned tiles choke gravity until peeled.",
      moves: 18,
      goals: [collect("heart", 12), collect("skull", 12)],
      shape: "stairs",
      colors: 6,
    ...
    L({
      ...
      moves: 16,
      goals: [collect("star", 14), collect("bolt", 12)],
      shape: "hourglass",
      colors: 6,
      obstaclePlan: [
    ...
    L({
      ...
      moves: 16,
      goals: [collect("gem", 16), collect("flame", 12)],
      shape: "rift",
      colors: 6,
      obstaclePlan: [
  ...
  const roof: LevelDef[] = [
    L({
      ...
      moves: 20,
      goals: [collect("heart", 18), collect("pizza", 10)],
      shape: "heart",
      colors: 6,
      obstaclePlan: [{ kind: "tape-x", pattern: "border", count: 5 }],
    ...
    L({
      ...
      moves: 18,
      goals: [collect("spray", 10), collect("bolt", 14)],
      shape: "lanes",
      colors: 6,
    ...
    L({
      ...
      moves: 16,
      goals: [collect("skull", 11), collect("star", 12)],
      shape: "plus",
      colors: 6,
    ...
    L({
      ...
      moves: 16,
      goals: [collect("flame", 14), collect("star", 10)],
      shape: "pillars",
      colors: 6,
    ...
    L({
      ...
      zone: "roof",
      name: "Corner Crown",
      brief: "Junk in every pocket — collect around it.",
      moves: 16,
      goals: [collect("flame", 16), collect("heart", 10)],
      shape: "corners",
      colors: 6,
      obstaclePlan: [
  ...
  const zonePalettes = [
    ["skull", "star", "flame", "heart", "bolt", "gem"] as const,
    ["skull", "star", "bolt", "gem", "spray", "soda", "ghost", "peace"] as const,
    [
      "flame",
      "heart",
      "bolt",
  ...
  return all.map((lv, i) => {
    ...
    const colors = Math.min(
      zonePalettes[zi]!.length,
      5 + zi + Math.floor(local / 3),
    );
    return {
      ...lv,
      colors,
      palette: [...zonePalettes[zi]!.slice(0, colors)],
      mapT: 0.08 + (local / 9) * 0.84,
      zone: ZONES[zi]!.id,
    };
  });
}
