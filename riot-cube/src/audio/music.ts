 ...
 * Shares the SFX AudioContext so Android doesn't duck the bed under every tick.
 */
import { getSharedAudioContext, isAudioUnlocked } from "./paper";
...
const VOL_KEY = "riotcube_music_vol";
const VOL_STEPS = [0, 0.35, 0.7] as const;
/** Keep music under SFX so twists stay crisp. */
const MUSIC_TRIM = 0.14;
