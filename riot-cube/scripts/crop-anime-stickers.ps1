...
# Uses whole-sheet connected-component detection (irregular rows, 14 stickers).
Add-Type -AssemblyName System.Drawing

$srcPath = Join-Path $PSScriptRoot "ref-stickers-anime.png"
$outDir = Join-Path (Split-Path $PSScriptRoot) "public\themes\anime"
New-Item -ItemType Directory -Force -Path $outDir | Out-Null

$names = @(
  'smirk', 'flame', 'ramen', 'mask', 'katana',
  'goggles', 'bubble', 'cat', 'control', 'juice',
  'peace', 'butterfly', 'school', 'tv'
)
