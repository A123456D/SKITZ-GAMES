# Crop edgy sticker sheets (2x12) → public/themes/edgy/*.png
# Reading order: sheet A then sheet B → TILE_KINDS filenames.
Add-Type -AssemblyName System.Drawing

$outDir = Join-Path (Split-Path $PSScriptRoot) "public\themes\edgy"
New-Item -ItemType Directory -Force -Path $outDir | Out-Null

$sheets = @(
  @{
    Path = Join-Path $PSScriptRoot "ref-stickers-edgy-a.png"
    Names = @(
  ...
  @{
    Path = Join-Path $PSScriptRoot "ref-stickers-edgy-b.png"
    Names = @(
