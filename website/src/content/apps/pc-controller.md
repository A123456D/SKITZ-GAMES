...
downloads:
  android: /apps/pc-controller/downloads/pc-controller.apk
---
...
**Free to sideload.** Download the APK, allow installs from this browser, then open **Pc Controller**. Look for **Pc Controller** in Bluetooth device lists.
